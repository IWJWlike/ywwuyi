        ...
        <div class="mod-header " id="Top">
            <dl class="header-wrap clearfix">
                ...
                <dd class="header-right clearfix">
                    <div class="nav-item">
                        <button id="one" href="#" class="login none nav-item-a login-require " target="_blank"><i
                                class="nav-item-txt">登录<span class="slash">/</span>注册</i></button>
                    </div>
                    ...
                    <div class="banner-content">
                        <div class="banner-search">
                            <ul class="search-tabs clearfix unselectable">
                                <li class="search-tab active" data-housetype="2" data-actionmap="/sale/map/"
                                    data-actionlist="/sale/guangzhou/">
                                    <span class="v-middle">二手房</span>
                                </li>
                                <li class="search-tab " data-housetype="1" data-actionmap="/chuzu/map/"
                                    data-actionlist="/chuzu/guangzhou/">
                            ...
                            <div class="search-form p-r">
                                ...
                                <form method="get" action="https://www.iwjw.com/sale/map/" class="mod-search clearfix"
                                      data-provinceid="40000" data-provincepy="guangzhou"
                                    ...
                                    <label class="search-label">
                                        ...
                                        <div class="index-kw-wrap">
                                            <input type="text" class="kw-input" name="kw" placeholder="请输入小区、地铁、区域板块…"
                                                   maxlength="50" autocomplete="off" autofocus=""><i
                                                class="iconfont search-close" title="清除内容">홈</i>
                                        </div>
                                    </label>
                            ...
                            <div class="wx-login">
                                    ...
                                    <div class="panel-wrap">
                                        <div class="block phone-panel">
                                            ...
                                            <div class="input-wrap">
                                                <input class="login-input" type="tel" name="mobile" maxlength="13"
                                                       placeholder="输入手机号码" tabindex="1" autocomplete="off">
                                ...
                                <div class="login-footer">
                                    ...
                                    <div class="block login-panel">
                                        <button class="dialog-login-btn" type="button" disabled="" tabindex="3">登录
                                        </button>
                                    </div>
                    ...
                    <div class="caichan-r">
                        ...
                        <div class="cc-section clearfix">
                            <div class="cc-section-l">
                                <a href="https://www.iwjw.com/baike/2110/" data-cid="2110" data-pos="1" target="_blank"
                                   class="title fs-nowrap point-link-gf">热点城市房价持续降温：很多人等降价</a>
                            ...
                            <div class="cc-section-r">
                                <a href="https://www.iwjw.com/baike/2110/" data-cid="2110" data-pos="1"
                                   class="point-link-gf" target="_blank">
                                    <img src="../../statics/images/link_img/fde82646dad344d78eecf400d79924c6.jpg"
                                         alt="">
                                </a>
                            </div>
                        </div>
                        <div class="cc-section last clearfix">
                            <div class="cc-section-l">
                                <a href="https://www.iwjw.com/baike/2109/" data-cid="2109" data-pos="2" target="_blank"
                                   class="title fs-nowrap point-link-gf">楼市十一遇冷 体现“房住不炒”政策导向</a>
                            ...
                            <div class="cc-section-r">
                                <a href="https://www.iwjw.com/baike/2109/" data-cid="2109" data-pos="2" target="_blank"
                                   class="point-link-gf">
                                    <img src="../../statics/images/link_img/e42ba18290cc4ab2a03c96e6c268d4e1.jpg"
                                         alt="">
                                </a>
                            </div>
                        </div>
                        <div class="cc-section-b clearfix">
                            <a href="https://www.iwjw.com/baike/2108/" data-cid="2108" data-pos="3" target="_blank"
                               class="title fs-nowrap point-link-gf">楼市调控下的“90后”：租买之间犹豫不决</a>
            ...
            <div class="index-like" data-provinceid="40000">
                <div class="index-inner index-like-inner" style="height: 300px;">
                    <div class="index-like-t clearfix">
                        ...
                        <a href="main/goSale" class="index-like-tab active" data-housetype="2">二手房</a>
                                ...
                                <div class="pic-wrap">
                                    <ul class="pic-slide clearfix" style="width: 7356px; left: 0px;">
                                        ...
                                        <li class="slide-item ml0"><a
                                                href="${pageContext.request.contextPath}/saleController/goSale"
                                                class="house-a" data-code="B7Or4soq7SY" data-remid="18124893" alt="白兰花园"
                                                target="_blank">
                                            <div class="imgbox"><img
                                                    src="../../statics/images/video_img/d7f7bb48e0d84070ad4c6eab51b37f6f.jpg"
                                                    alt="白兰花园" class="house-img" data-need-resize="auto"
                                                    data-has-webp="1"
                                            ...
                                            <div class="title-wrap clearfix"><p class="title fs-nowrap" title="白兰花园" >
                                                白兰花园</p><span class="money"><strong>700万</strong></span></div>
                                            <div class="des clearfix"><p class="des-l">2室1厅1卫 · 80 m²</p>
                                                <p class="des-r">8.75万/平</p></div>
                                        </a></li>

<%--<script>--%>
    <%--console.log("${pageContext.request.contextPath}/saleController/goSale","=======================");--%>
<%--</script>--%>
