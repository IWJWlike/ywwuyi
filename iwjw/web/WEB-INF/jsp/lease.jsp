...
<head>
    ...
    <script charset="utf-8" src="../../statics/js_lease/v.js.下载"></script>
    <script src="../../statics/js_lease/hm.js.下载" async=""></script>
    <script type="text/javascript" async="" src="../../statics/js_lease/vds.js.下载"></script>
    <script>
        ;(function () {
...
<div id="iwjw" class="short-footer">
    <div class="iwjw-wrap">
        ...
        <div class="header">
            <div class="wrap">
                <div class="nav">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/sell/goSell">我要卖房</a></li>
                        <li><a href="javascropt:scroll(0,0)" class="active">我要出租</a></li>
                    </ul>
                </div>
            </div>
        </div>

        <!--<div class="g-main"><div class="m-jumbotron"><div class="tit">发布出租房源</div><div class="sub-tit">8000+全国链家门店·10万+全国经纪人·链家倾情服务15年+</div></div>-->
        <div class="m-form">
            <div class="box-l m-entry" style="height: 480px">
                ...
                <dl>
                    <dt>期望租金</dt>
                    <dd>
                        <input name="expect_price" value="" type="text" placeholder="请输入您期望租出的价格" autocomplete="off"
                ...
                <dl>
                    <dt>手机号码</dt>
                    <dd style="height: 40px">
                        <input name="owner_mobile" value="" type="text" placeholder="您的联系方式，方便我们及时与您联系"
                               autocomplete="off" style="width: 250px;height: 40px">
                    </dd>
                </dl>
                <dl>
                    <dt>图形验证码</dt>
                    <dd>
                        ...
                        <div class="btn-getcode-sms"><img src="../../statics/images/GeneratePictureUpgrade.png"
    ...
    <div class="suspend-wrap">
        ...
        <!-- feedback -->
        <a href="https://www.iwjw.com/gofeedback#https%3A%2F%2Fwww.iwjw.com%2Fdelegation%2F"
...
<!--[if IE 8]>
<script src='../../statics/js_lease/es5-shim-sham_5.5.js'></script><![endif]-->
            ...
            <div class="footer-t-l">
                ...
                <div class="footer-t-bot">
                    ...
                    <span class="footer-t-b-item last"><a target="_blank"
                            ...
                            class="v-middle record-img" src="../../statics/images/beian.png"> 沪公网安备 31010702001120号</a></span>
                </div>
            </div>
...
<div style="display:none">
    ...
    <script async="" src="../../statics/js_lease/h.js.下载" type="text/javascript"></script>
    <script type="text/javascript">
        //
        <!-- 其他统计 -->
